...
const SERVICE_FIELDS = [
  ...
  ['imageUrls', 'image_urls'], ['active', 'active'], ['sort', 'sort_order'], ['area', 'area']
];
...
const CLIENT_FIELDS = [
  ...
  ['depositOnFile', 'deposit_on_file'], ['lastBirthdayGreetedYear', 'last_birthday_greeted_year'],
  ['createdAt', 'created_at'], ['updatedAt', 'updated_at']
];

const APPOINTMENT_FIELDS = [
  ['id', 'id'], ['clientId', 'client_id'], ['serviceId', 'service_id'],
  ['date', 'appt_date'], ['time', 'appt_time'], ['status', 'status'], ['staffId', 'staff_id'], ['groupId', 'group_id'],
...
const STAFF_FIELDS = [
  ...
  ['photoUrl', 'photo_url'], ['instagram', 'instagram'], ['active', 'active'], ['area', 'area'],
  ['sort', 'sort_order'], ['createdAt', 'created_at'], ['updatedAt', 'updated_at']
];
