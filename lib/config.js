...
const BIRTHDAY_WEBHOOK_URL = process.env.BIRTHDAY_WEBHOOK_URL || '';
...
const STATUS_FLOW = ['new', 'in_progress', 'pending_payment', 'confirmed', 'closed'];
const STATUS_LABELS = {
  new: 'NUEVA',
  ...
  closed: 'CERRADA',
  deleted: 'ELIMINADA',
  // legacy values from older records, mapped onto the current flow
  paid: 'CONFIRMADA',
  completed: 'CERRADA',
  cancelled: 'ELIMINADA'
};
...
module.exports = {
  ...
  WHATSAPP_ADMIN_PHONE, CLIENT_REMINDER_WEBHOOK_URL, CLIENT_REMINDER_HOURS, BIRTHDAY_WEBHOOK_URL,
